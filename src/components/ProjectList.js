const ProjectList = [
{
  ...
  title: "Sleep Log",
  description: "I sought to identify a correlation between the outside temperature and the amount of sleep I achieved nightly. The result is a full CRUD web app logging key sleep stats directly from my Fitbit tracker. The accompanying temperature is pulled in from an open weather API.",
  technologies_used:"Express.js, Node.js",
  image_url: "http://res.cloudinary.com/dm6ofsjtd/image/upload/v1527553398/sleeplog.png",
  url: "https://sleep-weather-app.herokuapp.com/"
},
{
  title: "Slot Game" ,
...
{
title:"Beer Calories",
  description:"Unsatisfied with the availability of beer nutrition calculator apps on the market, I created an API using exercise calorie expenditure data from my Fitbit and sourced beer nutrition facts from an open API. The result is an IOS calorie-counting app" ,
  technologies_used:"React Native, XCode, Ruby on Rails",
